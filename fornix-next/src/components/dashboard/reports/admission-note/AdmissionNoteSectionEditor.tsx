...
interface AdmissionNoteSectionEditorProps {
    section: string
    initialData: any
...
const AdmissionNoteSectionEditor: React.FC<AdmissionNoteSectionEditorProps> = ({
    section,
    initialData,
    onSave,
    onCancel
...
export default AdmissionNoteSectionEditor
