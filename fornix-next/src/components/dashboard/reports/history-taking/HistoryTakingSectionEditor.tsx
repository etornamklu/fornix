...
interface HistoryTakingSectionEditorProps {
    section: string
    initialData: any
...
const HistoryTakingSectionEditor: React.FC<HistoryTakingSectionEditorProps> = ({
    section,
    initialData,
    onSave,
    onCancel
...
export default HistoryTakingSectionEditor
