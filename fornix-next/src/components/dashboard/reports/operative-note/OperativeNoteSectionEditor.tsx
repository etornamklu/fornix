...
interface OperativeNoteSectionEditorProps {
    section: string
    initialData: any
...
const OperativeNoteSectionEditor: React.FC<OperativeNoteSectionEditorProps> = ({
    section,
    initialData,
    onSave,
    onCancel
...
export default OperativeNoteSectionEditor
