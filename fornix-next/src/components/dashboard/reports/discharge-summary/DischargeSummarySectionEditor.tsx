...
interface DischargeSummarySectionEditorProps {
    section: string
    initialData: any
...
const DischargeSummarySectionEditor: React.FC<DischargeSummarySectionEditorProps> = ({
    section,
    initialData,
    onSave,
    onCancel
...
export default DischargeSummarySectionEditor
