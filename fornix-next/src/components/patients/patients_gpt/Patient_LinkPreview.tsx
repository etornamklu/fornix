import { PatientsGptSourceLink, LogoVariants } from "@/utils/types"
...
export const PatientLinkPreview = ({ sourceLink }: { sourceLink: PatientsGptSourceLink }) => {
        ...
        <a
            ...
            <div className="flex h-32 w-full justify-between p-3">
                <div className="flex justify-center items-center w-1/3">
                    {mqlData?.image ? (
                        <img src={mqlData.image.url} alt={mqlData.title} className="w-full h-full object-cover" />
                    ) : (
