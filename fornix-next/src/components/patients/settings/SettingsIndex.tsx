        ...
        <div className="h-[100%] w-full md:px-3 md:h-screen px-0  md:mt-0">
            ...
            <section
                ...
                <aside className="hidden md:block pt-6 w-full md:w-1/4">
                    ...
                    {/*    <button*/}
                    {/*        className={`block ${*/}
                    {/*            active === 4 ? "bg-[#2381D2] text-[#2381D2]" : "text-gray-500 group hover:text-[#2381D2]"*/}
                    {/*        } flex items-center gap-2 justify-start w-full mb-2 font-medium p-2 rounded-[8px] bg-opacity-[0.06]`}*/}
                    {/*        onClick={() => setActive(4)}>*/}
                    {/*		<span className="w-5 h-5 flex items-center justify-center group-hover:text-[#2381D2]">*/}
                ...
                <div className="w-full rounded-r-[8px]  h-auto pt-3 md:bg-white md:pb-12 pb-6  border-[1px] md:border-[0]  md:overflow-y-auto md:border-l-[1px] border-border px-3 md:px-6">
                    ...
                    <aside className="md:hidden hide-scroll w-full overflow-x-auto mb-6 py-3 md:py-0 rounded-[8px] bg-[#F8FAFC]">
                        <div className="w-[150%] flex items-center justify-between">
                            <button
                                className={`px-4 text-[16px] p-2 ${active === 0 ? "text-black shadow-lg bg-white" : "text-gray-500 hover:text-black"} font-medium p-2 rounded-[8px]`}
                                onClick={() => setActive(0)}>
                                <p className="text-sm">General</p>
                            </button>
                            <button
                                className={`px-4 text-[16px] p-2 ${active === 1 ? "text-black shadow-lg bg-white" : "text-gray-500 hover:text-black"} font-medium p-2 rounded-[8px]`}
                                onClick={() => setActive(1)}>
                                <p className="text-sm">Security</p>
                            </button>
                            <button
                                className={`px-4 text-[16px] p-2 ${active === 2 ? "text-black shadow-lg bg-white" : "text-gray-500 hover:text-black"} font-medium p-2 rounded-[8px]`}
                                onClick={() => setActive(2)}>
                                <p className="text-sm">Subscription & billing</p>
                            </button>
                            <button
                                className={`px-4 text-[16px] p-2 ${active === 3 ? "text-black shadow-lg bg-white" : "text-gray-500 hover:text-black"} font-medium p-2 rounded-[8px]`}
                                onClick={() => setActive(3)}>
                                <p className="text-sm">Billing History</p>
                            </button>
                            <button
                                className={`px-4 text-[16px] p-2 ${active === 4 ? "text-black shadow-lg bg-white" : "text-gray-500 hover:text-black"} font-medium p-2 rounded-[8px]`}
                                onClick={() => setActive(4)}>
                                <p className="text-sm">Tokens & usage</p>
                            </button>
                        </div>
                    ...
                    <div className="w-full h-full md:pb-12  overflow-y-auto md:h-auto md:py-6">{pages[active]}</div>
                </div>
            </section>
        </div>
    )
